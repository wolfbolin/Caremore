...
public class ClientTest {
    ...
    public void receiveMessage(InputStream is) throws IOException {
        ...
        while(readsize != contextLenth1){
            readsize += is.read(context1,readsize,contextLenth1 - readsize);
        }
        readsize = 0;
        byte[] context2 = new byte[contextLenth2];
        while(readsize != contextLenth2){
            readsize += is.read(context2,readsize,contextLenth2 - readsize);
        }
